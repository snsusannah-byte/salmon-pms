...
from app.api.v1.endpoints import materials, material_categories, warehouse  # noqa: E402
...
# 注册 API routers
from app.api.v1 import api_router  # noqa: E402
from app.api.v1.endpoints import materials, material_categories, warehouse, client_errors  # noqa: E402
app.include_router(materials.router, prefix="/api/v4/materials", tags=["物料管理"])
app.include_router(material_categories.router, prefix="/api/v4/material-categories", tags=["物料分类"])
app.include_router(warehouse.router, prefix="/api/v4/warehouse", tags=["仓库管理"])
...
async def global_exception_handler(request: Request, exc: Exception):
    ...
    try:
        err_path = os.path.join(LOG_DIR, "client_errors.jsonl")
